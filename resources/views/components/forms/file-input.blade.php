...
@section('js')
 ...
 <script type="text/javascript">
       ...
       var CustomFile = (function(inputName, idAttr, uploadableFileCount, fileType) {
          ...
          function fileTemplate(inputName, index, customFileWrapperCount) {
            ...
            var actioButtons = shouldDisplayButton?'<div style="width: 100%;height: 25px;background: #;text-align: right;display: nsone;padding-right: 10px;padding-top: 3px;">'+
                        '<span index-id="'+index+'" style="line-height: 16px;font-size: 14px;padding: 4px 10px;background: darkred;color: #fff;cursor: pointer;border-radius: 50%;" id="'+removeButton+'">-</span>'+
                        '<span index-id="'+index+'" style="margin-left: 2px;line-height: 16px;font-size: 14px;padding: 4px 7px;background: darkgreen;color: #fff;cursor: pointer;border-radius: 50%;" id="'+addButton+'">+</span>'+
                    '</div>': '';

            return '<div style="background: ;height: 62px;margin-bottom: 10px;display: block;" class="custom-file-wrapper-'+idAttr+'" wrap-id="'+idAttr+index+'">'+
                    '<div style="width: calc( 100% - 2px );height: 35px;background: #ced4da;padding:1px;border-top-right-radius: 2px;border-bottom-right-radius: 2px;border-top-left-radius: 2px;border-bottom-left-radius: 2px;">'+
                        ...
                        '<div style="width: 108px;height: 33px;padding-top: 1px;background-color: #f5f5f5;float: left;border-left: 1px solid #ced4da;border-right: 1px solid #ced4da;">'+
                            ...
                            '<input type="file" id="'+idAttr+'" name="'+inputName+'" attr="drug-file-input" style="opacity: 0;width: 100%;height: 100%;z-index: 3;position: relative;cursor: pointer;" />'+
                        '</div>'+
       ...
       CustomFile('{{ $name }}', '{{ $id }}', '{{ $uploadableFileCount }}', "{{ strtolower($fileType) }}");
